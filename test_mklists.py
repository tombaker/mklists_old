...
#     assert x.urlify() == output
# 
# def test_urlify_url_with_question_mark():
...
#     assert x.urlify() == output
# 
# def test_urlify_url_with_hashsign():
...
#     assert x.urlify() == output
# 
# def test_urlify_url_with_colon():
...
#     assert x.urlify() == output
# 
# def test_urlify_url_with_escaped_characters():
...
#     assert x.urlify() == output
# 
# def test_urlify_url_with_colon2():
