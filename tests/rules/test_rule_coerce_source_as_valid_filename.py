...
def test_coerce_source_as_valid_filename():
...
def test_coerce_source_as_valid_filename_raise_exception_given_bad_string():
...
def test_coerce_source_as_valid_filename_raise_exception_given_none():
