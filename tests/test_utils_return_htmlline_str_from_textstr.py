"""Test utils.py - return_htmlline_str_from_textstr"""

from mklists.utils import return_htmlline_str_from_textstr


def test_utils_return_htmlline_str_from_textstr_linkified_line_already_linkified():
    """@@@Docstring"""
    ...
    assert return_htmlline_str_from_textstr(putin) == putout


def test_utils_return_htmlline_str_from_textstr_linkified_line():
    """@@@Docstring"""
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_non_url():
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_url_with_question_mark():
    """@@@Docstring"""
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_url_with_ip_address():
    """@@@Docstring"""
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_url_with_3d():
    """@@@Docstring"""
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_url_with_hashsign():
    """@@@Docstring"""
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_url_with_colon():
    """@@@Docstring"""
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_url_with_escaped_characters():
    """@@@Docstring"""
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_url_with_colon2():
    """@@@Docstring"""
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_url_with_bang():
    """@@@Docstring"""
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_url_with_comma():
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_url_with_https():
    """@@@Docstring"""
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_surrounded_by_brackets():
...
def test_utils_return_htmlline_str_from_textstr_linkified_line_with_two_urls():
    """@@@Docstring"""
...
def test_utils_return_htmlline_str_from_textstr_not_including_linefeed():
    """@@@Docstring"""
