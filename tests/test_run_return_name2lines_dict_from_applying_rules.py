...
def test_return_names2lines_dict_from_rules_and_lines_correct_result():
    ...
    return_names2lines_dict_from_rules_and_lines(
        _ruleobjs_list=ruleobjs_list, _datalines_list=datalines_list
    ) == result_dict


def test_return_names2lines_dict_from_rules_and_lines_another_correct_result():
    """Returns correct dictionary from good inputs."""
...
def test_return_names2lines_dict_from_rules_and_lines_yet_another_correct_result():
    """Returns correct dictionary from good inputs."""
    ruleobjs_list = [
...
def test_return_names2lines_dict_from_rules_and_lines_correct_result_too():
    """Returns correct dictionary from good inputs."""
...
def test_return_names2lines_dict_from_rules_and_lines_no_rules_specified():
...
def test_return_names2lines_dict_from_rules_and_lines_no_rules_specified_either():
...
def test_return_names2lines_dict_from_rules_and_lines_no_data_specified():
...
def test_return_names2lines_dict_from_rules_and_lines_no_data_specified_either():
