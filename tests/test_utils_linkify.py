"""Test utils.py - get_html_string_from_text_string"""

from mklists.utils import get_html_string_from_text_string


def test_utils_get_html_string_from_text_string_linkified_line_already_linkified():
    ...
    assert get_html_string_from_text_string(putin) == putout


def test_utils_get_html_string_from_text_string_linkified_line():
    putin = """http://example.org"""
    putout = """<a href="http://example.org">http://example.org</a>"""
    assert get_html_string_from_text_string(putin) == putout


def test_utils_get_html_string_from_text_string_linkified_line_non_url():
...
def test_utils_get_html_string_from_text_string_linkified_line_url_with_question_mark():
...
def test_utils_get_html_string_from_text_string_linkified_line_url_with_ip_address():
    putin = """http://192.168.56.100:8888/"""
    putout = """<a href="http://192.168.56.100:8888/">http://192.168.56.100:8888/</a>"""
    assert get_html_string_from_text_string(putin) == putout


def test_utils_get_html_string_from_text_string_linkified_line_url_with_3d():
...
def test_utils_get_html_string_from_text_string_linkified_line_url_with_hashsign():
...
def test_utils_get_html_string_from_text_string_linkified_line_url_with_colon():
...
def test_utils_get_html_string_from_text_string_linkified_line_url_with_escaped_characters():
...
def test_utils_get_html_string_from_text_string_linkified_line_url_with_colon2():
...
def test_utils_get_html_string_from_text_string_linkified_line_url_with_bang():
    putin = """http://twitter.com/#!/search/%23dcmi11"""
    putout = """<a href="http://twitter.com/#!/search/%23dcmi11">http://twitter.com/#!/search/%23dcmi11</a>"""
    assert get_html_string_from_text_string(putin) == putout


def test_utils_get_html_string_from_text_string_linkified_line_url_with_comma():
...
def test_utils_get_html_string_from_text_string_linkified_line_url_with_https():
...
def test_utils_get_html_string_from_text_string_linkified_line_surrounded_by_brackets():
...
def test_utils_get_html_string_from_text_string_linkified_line_with_two_urls():
