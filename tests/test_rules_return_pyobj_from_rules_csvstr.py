...
from mklists.rules import Rule, _return_pyobj_from_rules_csvstr
...
def test_run_return_ruleobj_list_from_pyobj(tmpdir):
    ...
    real = _return_pyobj_from_rules_csvstr(csvstr=TEST_RULES_YAMLSTR)
    assert real == expected


def test_run_return_ruleobj_list_from_pyobj_no_rules(tmpdir):
    """@@@Docstring"""
