...
def test_returns_filename_is_valid_as_filename_false_because_dotfile():
...
def test_returns_filename_is_valid_as_filename_false_because_emacs_backup_file():
...
def test_returns_filename_is_valid_as_filename_bad_filename_extension():
    """@@@Docstring"""
    fname = "foobar.swp"
    bad_patterns = ["\\.swp$", "\\.tmp$", "~$", "^\\."]
    assert (
