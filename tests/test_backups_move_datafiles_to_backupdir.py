...
import os
import pytest
from mklists.run import move_datafiles_to_backupdir


def test_move_datafiles_to_backupdir(tmpdir):
...
def test_move_datafiles_to_backupdir_no_backupdir_specified(tmpdir):
